    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="pt-8 pb-6 px-8 text-center">
          ...
          <p className="text-gray-500 text-sm">{activeTab === "login" ? t("loginSubtitle") : t("signupSubtitle")}</p>
        </div>
        ...
        <div className="p-8 pt-6">
          {activeTab === "login" ? (
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <Button type="submit" className="w-full h-11 bg-[#1a1a1a] hover:bg-black text-white font-medium">
                {t("loginButton")}
              </Button>
            </form>
          ) : (
          ...
          <div className="flex justify-center">
            <Button variant="outline" className="h-11 border-gray-200 hover:bg-gray-50 bg-transparent px-8">
          ...
          {/* Terms */}
          <p className="text-xs text-gray-400 text-center mt-6">{t("termsText")}</p>
        </div>
      </div>
    </div>
  )
